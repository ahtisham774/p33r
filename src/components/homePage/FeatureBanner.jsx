...
import CategorySVG from '../landingPage/svg/category'
import BudgetSVG from '../landingPage/svg/budget'
import MustHaveSVG from '../landingPage/svg/mustHave'
...
export function FeaturesBanner () {
  ...
  return (
    <div className='w-full py-20'>
      <div className='bg-grayish rounded md:rounded-full p-2 px-4'>
        <div className='grid grid-cols-1 md:grid-cols-5 gap-6'>
         ...
         <Button text='Build Your Profile' className="!rounded-full" />
        </div>
      </div>
    </div>
  )
